package com.whitezealots.squad_1.bio_auth;
...
public class Bio_metric_auth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!pref.getBoolean("mode",false)){
            RelativeLayout layout = findViewById(R.id.bio_metric_auth_activity);
            layout.setBackgroundResource(R.drawable.bg_1);
            TextView tx =findViewById(R.id.locked_text_view);
            ...
            ImageView imageView;
            imageView = findViewById(R.id.imageView);
            imageView.setBackgroundResource(R.drawable.dark_fingerprint);
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!keyguardManager.isKeyguardSecure()) {
                ...
                if (initCipher()) {
                    ...
                    FingerprintHandler helper = new FingerprintHandler(Bio_metric_auth.this);
